...
@section('header')
    <div id="header" style="background-image: url('{{ asset('img/login2.jpg')  }}');
    max-height: all !important; top: 9vh;">
                    	...
                    	<div class="row">
                    		<div class="col">
                    			<div class="row mr-3 ml-2">
			                        ...
			                        <h5><i class="fas fa-project-diagram text-success"></i> Titulo 1</h5>
			                        <p class="ml-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
			                    ...
			                    <div class="row mr-3 ml-2">
			                        ...
			                        <h5><i class="fas fa-chart-pie  text-danger"></i> Titulo 2</h5>
			                        <p class="ml-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
			                        tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
			                        </p>
			                    ...
			                    <div class="row mr-3 ml-2">
			                        ...
			                        <h5><i class="fas fa-chart-area  text-primary"></i> Titulo 3</h5>
			                        <p class="ml-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
			                        tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
			                        </p>
